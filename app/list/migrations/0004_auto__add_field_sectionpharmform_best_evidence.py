...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SectionPharmForm.best_evidence'
        db.add_column('list_sectionpharmform', 'best_evidence', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SectionPharmForm.best_evidence'
        db.delete_column('list_sectionpharmform', 'best_evidence')
