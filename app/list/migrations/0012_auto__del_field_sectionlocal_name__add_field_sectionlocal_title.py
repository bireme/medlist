...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SectionLocal.name'
        db.delete_column('list_sectionlocal', 'name')

        # Adding field 'SectionLocal.title'
        db.add_column('list_sectionlocal', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SectionLocal.name'
        db.add_column('list_sectionlocal', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)

        # Deleting field 'SectionLocal.title'
        db.delete_column('list_sectionlocal', 'title')
