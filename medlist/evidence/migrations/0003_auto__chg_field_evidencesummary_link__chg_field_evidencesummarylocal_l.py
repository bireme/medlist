...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EvidenceSummary.link'
        db.alter_column('evidence_evidencesummary', 'link', self.gf('django.db.models.fields.TextField')())

        # Changing field 'EvidenceSummaryLocal.link'
        db.alter_column('evidence_evidencesummarylocal', 'link', self.gf('django.db.models.fields.TextField')())
    models = {
        'directory.medicine': {
