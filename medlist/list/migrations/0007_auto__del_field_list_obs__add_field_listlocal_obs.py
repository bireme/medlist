...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'List.obs'
        db.delete_column('list_list', 'obs')

        # Adding field 'ListLocal.obs'
        db.add_column('list_listlocal', 'obs', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'List.obs'
        db.add_column('list_list', 'obs', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'ListLocal.obs'
        db.delete_column('list_listlocal', 'obs')
