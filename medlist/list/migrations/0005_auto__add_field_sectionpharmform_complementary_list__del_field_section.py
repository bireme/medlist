...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SectionPharmForm.complementary_list'
        db.add_column('list_sectionpharmform', 'complementary_list', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Section.complementary_list'
        db.delete_column('list_section', 'complementary_list')


    def backwards(self, orm):
        
        # Deleting field 'SectionPharmForm.complementary_list'
        db.delete_column('list_sectionpharmform', 'complementary_list')

        # Adding field 'Section.complementary_list'
        db.add_column('list_section', 'complementary_list', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
