...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SectionPharmForm.observation_es'
        db.add_column('list_sectionpharmform', 'observation_es',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SectionPharmForm.observation_pt'
        db.add_column('list_sectionpharmform', 'observation_pt',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SectionPharmForm.restriction_age_es'
        db.add_column('list_sectionpharmform', 'restriction_age_es',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SectionPharmForm.restriction_age_pt'
        db.add_column('list_sectionpharmform', 'restriction_age_pt',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SectionPharmForm.observation_es'
        db.delete_column('list_sectionpharmform', 'observation_es')

        # Deleting field 'SectionPharmForm.observation_pt'
        db.delete_column('list_sectionpharmform', 'observation_pt')

        # Deleting field 'SectionPharmForm.restriction_age_es'
        db.delete_column('list_sectionpharmform', 'restriction_age_es')

        # Deleting field 'SectionPharmForm.restriction_age_pt'
        db.delete_column('list_sectionpharmform', 'restriction_age_pt')
