...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SectionLocal.observation'
        db.add_column('list_sectionlocal', 'observation', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SectionLocal.observation'
        db.delete_column('list_sectionlocal', 'observation')
